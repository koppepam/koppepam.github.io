...
export default function Works() {
  ...
  return (
    <>
      <p id="works" className="js-show-on-scroll text-3xl font-bold mb-10">Works</p>
      <div className="grid lg:grid-cols-2 text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:text-left">
        <Worksframe title="災害情報お知らせアプリ" image="/images/disaster-info.png" worklink="https://disaster-info-6cpa.onrender.com/" codelink="https://github.com/koppepam/disaster-info" detailLink="/works/disaster-info">
          <p className="mt-10 lg:max-w-[55ch] w-full text-sm opacity-50">
            N予備校Webアプリケーションコンテスト2023冬 学園部門 優秀賞受賞<br/>
            気象庁防災情報XMLをもとに、災害情報を通知するアプリです。LINE Botでのプッシュ通知機能を実装しました。
          </p>
